...
public class PrevousCallListAdapter extends BaseAdapter{
    ...
    public PrevousCallListAdapter(Context aContext, ArrayList<PreviousCallModel> previousCalls) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder holder;
        if (convertView == null) {
            convertView = layoutInflater.inflate(R.layout.select_previous_code_item, null);
